...
const CreateJobPost = ({ navigation }) => {
    ...
    // Xử lý khi nhấn nút "Thêm bài đăng"
    const handleSubmit = async () => {
        if (validate()) {
            ...
            const data = await createJobPost(jobPost);
            if (data.success) {
                resetForm();
        ...
        <View className="flex-1 bg-gray-50">
            ...
            <ScrollView className="flex-1 px-6">
                ...
                <View className="flex-row justify-between gap-2 py-3 ">
                    ...
                    <TouchableOpacity className="bg-green-600 rounded-full py-3 w-[70%]" onPress={handleSubmit}>
                        <Text className="text-white text-center font-bold text-base">Thêm bài đăng</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
